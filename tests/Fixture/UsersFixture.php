...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'email_verified_at' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => false, 'default' => null, 'comment' => ''],
        'role' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'email_verified_at' => '2019-11-22 19:39:27',
                'role' => 'Lorem ipsum dolor sit amet',
                'created' => '2019-11-22 19:39:27',
                'modified' => '2019-11-22 19:39:27',
            ],
        ];
        parent::init();
    }
